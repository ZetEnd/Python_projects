...
def check(m,param):
    ...
    print(f"1 x_r {x_r} x_l {x_l} mas[xi_r][1] {mas[xi_r][1]} mas[xi_l][1] {mas[xi_l][1]}")
    print(f"2 y_r {y_r} y_l {y_l} mas[yi_r][0] {mas[yi_r][0]} mas[yi_l][0] {mas[yi_l][0]}")
    print()
    ...
    print(f"m = {m} minx1 {minx1} minx2 {minx2} miny1 {miny1} miny2 {miny2}")
